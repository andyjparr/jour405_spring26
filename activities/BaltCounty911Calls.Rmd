...
There's a lot of up and down from day to day to keep the average amount of calls around 10. That said, it looks like the call count was slightly higher in summer months, but the points that catch my eye and should be inspected are the very high peak in early October, then also the low dips at the end of Jan 2023 and June 2022. There also seems to be a high-ish peak at New Year's, which makes sense.
...
It flagged much more of the dates than I thought of as outliers in task three. I called out two unusually high peaks and two unusually low dips, while this graph points out 11 peaks as being high and seven as being low.
...
The average amount of calls received on Tuesdays in 2022 was 10.35, but on Tuesday 10/4/22, there were 23 calls, an amount way over the range of expected amounts.
...
1/1/23 (New Year's Day) was tied for the second-highest standard deviation in the data.
...
Some possible stories: New Year's Day experienced one of the most unusually high amounts of calls, were there any spots that had an extra high concentration for one area/party? Look into the addresses from that day and see if multiple are from the same spot or very close by, is there a larger picture in play there

What the hell happened on Oct. 4? Look into the addressed, call times and see if there's a bigger pattern in play there too.
