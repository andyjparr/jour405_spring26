...
The mean and standard deviations are very close between the population and the sample. The mean is a tiny bit higher on the population and the standard deviation is a bit higher on the sample. When the sample size decreased to 20, the mean stayed about the same, (actually a bit closer to the population), but the standard deviation got a bit higher. Then, when I did the final run with a sample size of five, the mean fell down lower and the standard deviation was its highest so far. 

ISSUES WITH GITHUB COMMIT BEING PUSHED, MIGHT BE LATE
