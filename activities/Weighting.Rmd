...
A lower weight means their response doesn't have as much sway on the final results, unlike respondents with a higher weight. In this case, .23 counts less towards the results than 3.04
3. Why might some respondents be weighted more heavily than others?
The lower the weight, the better-represented that individual is within their demographic for the specific dataset. If an individual is weighted higher, it means their demographic is under represented so their response gets more weight to try and balance numbers out
...
"Rarely/never" has the largest difference between weighted and unweighted results

2. How might these differences affect reporting on likely voter turnout?

People in the "rarely/never" category might be overvalued if their responses are not weighted, as the "yes" category dropped by 3.6% after the weighting system was put into effect
...
They exist because these polls typically rely on people answering calls or taking initiative. Due to this fact of the polling system, it can usually lead to younger demographics or ones in rural areas not responding, either due to a lack of urgency for filling out these surveys or a lack of ability to get the chance
