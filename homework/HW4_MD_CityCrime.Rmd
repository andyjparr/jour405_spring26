...
#11 cities are at or above the 90th percentile
```
...
```{r}
md_cities_rates |> summarize(iqr_violent_2020 = IQR(violent_rate_2020))

#The IQR for 2020 violent crime rate is about 4.20
```


Do the results change your best story idea from the previous assignment? Why or why not?

Not really, the story I was focused on centered around populations and overall trends in rate vs. population, with a specific focus on Ocean City's high crime rate (the city in the 100th percentile).
