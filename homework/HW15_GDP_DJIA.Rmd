...
gdp_djia_data |> 
  ...
  labs(
    x = "GDP Value",
    y = "DJIA Value",
    title = "GDP and DJIA rise and fall together"
  )
```
...
Yes, there is a very strong, positive correlation between the DJIA and GDP. The pearson calculation put the coefficient at about 0.95, very close to the maximum possible value of 1.00 This relationship is also reflect in the scatterplot and its line of best fit. For quarters with a lower GDP, the DJIA was also lower. Same goes with higher GDPs having higher DJIAs, creating a line of best fit that was nearly a perfect 45 degrees.
