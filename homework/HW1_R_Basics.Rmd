...
Not sure if I did the renaming part right, I kept copying over from the code on the website and it gave me error messages. But, when I deleted the "rename" code, the table comes out with the correct labels. Not sure why that's the case.
