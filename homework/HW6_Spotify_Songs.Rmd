...
The data does not appear to have a normal distribution, but is rather skewed left. That said, since one standard deviation on either side of the mean contains around 68% of the songs, this means that the vast majority of songs have a danceability rating over .5 since one standard deviation below the mean is still above that number. One potential story is that over 84% of spotify songs from this 2020 dataset had a relatively "good" danceability score (a score over .5 on the danceability scale).
